...
if(!empty($data -> utilisateurId) ) {
    ...
    $sql = "SELECT ENTREE.ID as ENTID, ALIMENT.NOM as ALINOM, ALIMENT.ISLIQUIDE as ALIISLIQUIDE, CATEGORIE_ALIMENT.NOM as CATNOM, ENTREE.QUANTITE as QUA, ENTREE.DATE as DATE 
    FROM ENTREE 
